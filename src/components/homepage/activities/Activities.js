  ...
  return (
    <div className='activities-container' id='activities'>
      ...
      <div className='card-activities'>
        ...
        <Oddcard num='3' statement='Level3 = 8persons and cost 4k Those 8persons send you 4k each 8x4,000=#32,000Upgrade fee to level4 is 8k, so take-home in level3 is 24k' />
        <Evencard num='4' statement= 'Level4 = 16persons and cost 8kThose 16persons send you 8k each 16x8,000=#128,000 Upgrade fee to level5 is 16k, so take-home in level4 is #112,000'/>
        <Oddcard num='5' statement='Level5 = 32persons cost 16k Those 32persons send you #16k each 32×16,000=#512,000Upgrade fee to level6 is 32k, so take-home in level5 is #480,000' />
        <Evencard num='6' statement= 'Level6 = 64persons cost 32k Those 64persons send you 32k each64×32,000=#2,048,000 Upgrade fee to level7 is 64k, so take-home in level6 is #1,984,000'/>
        <Oddcard num='7' statement='Level7 = 128persons cost #64k Those 128persons send you 64k each 128×64,000=#8,192,000Upgrade fee to level8 is #128,000 so take-home in level7 is #8,064,000' />
