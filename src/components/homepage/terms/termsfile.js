...
<p>Active and inactive accounts start from the point of registration. Registration without membership fee remains inactive for 1 hour and is deleted from the system. However, if the membership fee is paid within 1 hour, the account becomes active.</p>
<p>After receiving the first and second payment in any level, the system will start requesting the member to upgrade to the next level. If the upgrade is delayed before 1 hour TIME OUT, it becomes inactive and will not receive payment during the inactive period until paid up, and the account returns active.</p>
<p>Members should not delay the approval of payment made into their bank account and submitted to their dashboard for approval for 1 hour because delaying affects the member who made payment to you from stepping up to the level he/she paid you for, such attracted penalty if reported to the support team with payment proof.</p>
<p>The same thing goes for delay of monthly advert fee. After 1 hour TIME OUT, the account goes inactive and will not receive payment until paid up, and any payment lost during the inactive period will not be recovered.</p>
