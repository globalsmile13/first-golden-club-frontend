        ...
        <div className='receivedportal-second'>
            ...
            {transactionDetails && transactionDetails.filter(item => item.transaction_type === "credit").length === 0 && <p>No transactions found</p>}
            {
                ...
                <div>
                    <div className='receivedportal-details'>
                        <div>
                            <p className='receivedportal-name'>Cliton Sylvester</p>
                            <p className='receivedportal-date'>Nov 24, 2020 | 09:26:08 AM</p>
                            <p className='receivedportal-cash'>-N 16,000.00</p>
                        </div>
                        <div className='receivedportal-svg'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 46 46" fill="none">
                                <circle cx="23" cy="23" r="23" fill="#51CF66"/>
